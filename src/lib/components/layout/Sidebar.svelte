					...
					<div class="self-center">
						...
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
								d="M3 15.5L8.5 10 12 13.5 20.5 5M3 18.5h18.5M6 21.5V10M12 21.5V13.5M18 21.5V5"
							/>
						</svg>
					</div>

					<div class="flex self-center translate-y-[0.5px]">
						<div class=" self-center font-medium text-sm font-primary">{$i18n.t('Financeinvest')}</div>
					</div>
				</a>
			</div>
		{/if}
					...
					<div class="self-center">
						...
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
								d="M4 12l4 4 4-4 4 4 4-4M8 18h8"
							/>
						</svg>
					</div>

					<div class="flex self-center translate-y-[0.5px]">
						<div class=" self-center font-medium text-sm font-primary">{$i18n.t('Lifesciences')}</div>
					</div>
				</a>
			</div>
		{/if}
